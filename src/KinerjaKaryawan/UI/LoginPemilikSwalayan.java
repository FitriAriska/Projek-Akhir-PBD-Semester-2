 ...
 * @author H P
 */
public class LoginPemilikSwalayan extends javax.swing.JFrame {
  
  
    /**
     * Creates new form LoginKinerjaKaryawan
     */
    public LoginPemilikSwalayan() {
        initComponents();
...
if(usernameTxt.getText().equals("")){
        ...
        } else if (usernameTxt.getText().contains("gazzazmart")&&passwordTxt.getText().contains("1234")){
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new LoginPemilikSwalayan().setVisible(true);
            }
        });
    }
